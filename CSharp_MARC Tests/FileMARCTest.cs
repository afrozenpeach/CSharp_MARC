	...
	public class FileMARCTest
	{
		...
		public void FileMARCConstructorTest1()
		{
...

			{
				...
				string actual = target.RawSource[0];
				Assert.AreEqual(expected, actual);
			}
		}
